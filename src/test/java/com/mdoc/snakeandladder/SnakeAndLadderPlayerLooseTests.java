...
public class SnakeAndLadderPlayerLooseTests {
    ...
    public static Collection<Object[]> data() {
        Object[][] data = new Object[][] {
                ...
                {6,8,500,PlayerStatus.PLAYING},
                {6,2,400,PlayerStatus.PLAYING},
                {6,8,400,PlayerStatus.PLAYING},
                {6,2,300,PlayerStatus.PLAYING},
                {6,8,300,PlayerStatus.PLAYING},
                {6,2,200,PlayerStatus.PLAYING},
                {6,8,200,PlayerStatus.PLAYING},
                {6,2,100,PlayerStatus.PLAYING},
                {6,8,100,PlayerStatus.PLAYING},
                {6,2,0,PlayerStatus.LOST}
        };
